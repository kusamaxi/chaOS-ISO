...
* implementing pacman.conf with chaos-repo on top
...
* https://github.com/kusamaxi/chaos-theming/tree/artemis_neo


# April, May 2022 // @keybreak and @killajoe ISO process cleanup for package handling and LiveSession creation:

* [packages.x86_64](https://github.com/kusamaxi/chaOS-ISO/blob/main/packages.x86_64)
and:
* [chrooted_cleaner_script.sh#L181](https://github.com/kusamaxi/chaOS-calamares/blob/13511822baa4cb9414d837b9b2ccb258335010aa/calamares/scripts/chrooted_cleaner_script.sh#L181)
...
[run_before_squashfs.sh](https://github.com/kusamaxi/chaOS-ISO/blob/main/run_before_squashfs.sh)
...
[profiledef.sh](https://github.com/kusamaxi/chaOS-ISO/blob/main/profiledef.sh)
`fixpermissions.sh` is gone and no need to fix permissions in a third place on livesession setup anymore.

[prepare.sh](https://github.com/kusamaxi/chaOS-ISO/blob/main/prepare.sh)
...
- https://github.com/kusamaxi/chaOS-ISO/commit/c8603d5cb5805da0e68c52fbea054f4ccab0064a
- https://github.com/kusamaxi/chaOS-ISO/commit/c484f3895770870013d33ac5483e15abb13f6b37
...
Adding [mkarchiso-changes.md](https://github.com/kusamaxi/chaOS-ISO/blob/main/mkarchiso-changes.md) to keep track of changes on the mkarchiso script for updating it to the latest version from time to time.
